...
public class ass6tester {
	public static void main(String a[]){
		...
		System.out.println("Number of foreign students who came to Canada before Jan 1, 2010 is " + 
				ourUniversity. numberOfForeignStudentLivingInCanadaSince2010());
